...
hl.bind("Print",               hl.dsp.exec_cmd("/home/joshuaddf/.local/bin/hypr-screenshot full"))
hl.bind("SHIFT + Print",       hl.dsp.exec_cmd("/home/joshuaddf/.local/bin/hypr-screenshot region"))
